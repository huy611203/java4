...
@Entity
@Table(name="Videos")
@NamedQuery(name="Video.findAll", query="SELECT v FROM Videos v")
public class Videos implements Serializable {
	...
	public Videos(String id, boolean active, String description, String poster, String title, int view) {
		super();
		this.id = id;
		this.active = active;
